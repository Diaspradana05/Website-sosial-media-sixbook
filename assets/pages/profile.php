...
// Fetch the user's biodata (assuming $profile['biodata'] contains the biodata information)
$biodata = $profile['biodata'];

// Function to parse the biodata string into an associative array
function parseBiodata($biodata) {
    $data = [];
    $lines = explode("\n", $biodata);
...
// Parse the biodata
$biodataArray = parseBiodata($biodata);
?>
            ...
            <div class="d-flex flex-column">
                ...
                <?php if(!checkBS($profile['id'])): ?>
                    ...
                    <div class="border-top pt-3 mt-3">
                        <h5>Biodata</h5>
                        <p><strong>Tanggal Lahir:</strong> <?=$biodataArray['Tanggal Lahir']?></p>
                        <p><strong>Alamat:</strong> <?=$biodataArray['Alamat']?></p>
                        <p><strong>Pekerjaan:</strong> <?=$biodataArray['Pekerjaan']?></p>
                        <p><strong>Hobi:</strong> <?=$biodataArray['Hobi']?></p>
                    </div>
                    <!-- End of Biodata Section -->
