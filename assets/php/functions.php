...
function validateUpdateForm($form_data, $image_data) {
    ...
    // Validate biodata
    if (!$form_data['biodata']) {
        $response['msg'] = "Biodata is not given";
        $response['status'] = false;
        $response['field'] = 'biodata';
    }
    ...
    function updateProfile($data, $imagedata) {
        ...
        $username = mysqli_real_escape_string($db, $data['username']);
        $password = mysqli_real_escape_string($db, $data['password']);
        $biodata = mysqli_real_escape_string($db, $data['biodata']);
        ...
        $query = "UPDATE users SET first_name = '$first_name', last_name='$last_name', username='$username', password='$password', biodata='$biodata' $profile_pic WHERE id=" . $_SESSION['userdata']['id'];
        return mysqli_query($db, $query);
    }
